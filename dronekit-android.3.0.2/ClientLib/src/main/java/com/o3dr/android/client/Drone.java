...
public class Drone {
    ...
    public boolean isConnected() {
        final IDroneApi droneApi = droneApiRef.get();
        State droneState = getAttribute(AttributeType.STATE);
        Timber.tag("Drone").d("Drone is connected? %s", isStarted(droneApi) && droneState.isConnected());
        Timber.tag("Drone").d("Is API started? %s", isStarted(droneApi));
        Timber.tag("Drone").d("Is Drone connected %s", droneState.isConnected());
